        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <form class="space-y-6" @submit.prevent="login">
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input v-model="user.login" id="login" autocomplete="current-login" name="login" type="text" required class="input" />
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input v-model="user.password" id="password" autocomplete="current-password" name="password" type="password" required class="input" />
                    </div>
                </div>
            ...
            <p class="mt-10 text-center text-sm text-gray-500">
                Akkaunt yo`qmi?
                {{ ' ' }}
                <router-link :to="{name: 'signup'}" class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">Ro`yxatdan o`ting</router-link>
            </p>
        </div>
    </div>
</template>
